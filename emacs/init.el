...
(custom-set-variables
 ...
 '(package-selected-packages
   '(markdown-mode company-box company typescript-mode lsp-ivy lsp-treemacs lsp-ui lsp-mode evil-collection ivy-rich which-key rainbow-delimiters doom-modeline counsel ivy use-package)))
(custom-set-faces
